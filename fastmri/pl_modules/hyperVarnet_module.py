...
from fastmri.models import HyperVarNet

from .mri_module import MriModule


class HyperVarNetModule(MriModule):
    """
    ...
    def forward(self, masked_kspace, mask, num_low_frequencies):
        return self.hyperVarnet(masked_kspace, mask, num_low_frequencies)
    ...
    def add_model_specific_args(parent_parser):  # pragma: no-cover
        ...
        parser.add_argument(
            ...
            default=2,
            type=int,
            help="Number of phase harmonics",
        )
