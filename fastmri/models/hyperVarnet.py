...
from .hyperUnet import HyperUnet
from .varnet import NormUnet

class NormHyperUnet(nn.Module):
    """
    Normalized Hyper U-Net model.
    ...
    def __init__(
        ...
        self.unet = HyperUnet(
            ...
            chans=chans,
            drop_prob=drop_prob,
            ph_n=ph_n,  # Number of phase harmonics
...
class HyperVarNet(nn.Module):
    ...
    def __init__(
        ...
        self.cascades = nn.ModuleList(
            [HyperVarNetBlock(NormHyperUnet(chans, pools, ph_n)) for _ in range(num_cascades)]
        )
...
class HyperVarNetBlock(nn.Module):
    """
