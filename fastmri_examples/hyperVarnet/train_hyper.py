...
from fastmri.pl_modules import FastMriDataModule, HyperVarNetModule
...
def build_args():
    ...
    # module config
    parser = HyperVarNetModule.add_model_specific_args(parser)
    parser.set_defaults(
    ...
    # parser.set_defaults(logger = comet_logger)
